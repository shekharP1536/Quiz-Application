...
function showQuestions(index) {
  ...
  let creator =
    "<span>Created by <strong>" + questions[index].creator + "</strong></span>";
...
function showResult() {
  ...
  if (userScore > 3) {
    ...
    let scoreTag =
      "<span>and congrats! 🎉, You attendend <p>" +
      userScore +
      "</p> out of <p>" +
      questions.length +
      "</p></span>";
    ...
    let scoreTag =
      "<span>and sorry 😐, You attendend only <p>" +
      userScore +
      "</p> out of <p>" +
      questions.length +
      "</p></span>";
